...
datasets = [ 
            ...
            # },
            {
                "file": "/home/elena/fit/H-Pt/T-bajas/40-fsi-T220-fr280-N4096-x4p2-xa4-g005-dt10-w50_N_800000.dat",
                "Name": "fsi-T220N_800000.dat",
                "Temperature": "x=±4.2, dt=0.01ps",
                "tc_p0":2,
                "tmin_int": 2,
                "tmax_int": 8,
                "tm_ajuste":3,
                ...
                "y_min_F": 0.35,
                "output": "/home/elena/fit/H-Pt/ajustes/40-fsi-T220-fr280-N4096-x4p2-xa4-g005-dt10-w50_N_800000.pdf"
            },
            {
                "file": "/home/elena/fit/H-Pt/T-bajas/56-fsi-T220-fr280-N4096-x4p2-xa4-g001-dt20-w200_N_100000.dat",
                "Name": "fsi-T220N_10000.dat",
                "Temperature": "x=±4.2, dt=0.02ps",
                "tc_p0": 5,
                "tmin_int": 5,
                "tmax_int": 10,
                "tm_ajuste":8.2,
            ...
            # },
            {
                "file": "/home/elena/fit/H-Pt/T-bajas/42-fsi-T220-fr280-N4096-x4p2-xa4-g005-dt50-w50_N_800000.dat",
                "Name": "fsi-T220N-xa4-g005-dt40_800000.dat",
                "Temperature": "x=±4.2, dt=0.04ps",
                "tc_p0":2,
                "tmin_int": 2,
                "tmax_int": 4.5,
                "tm_ajuste":3,
                ...
                "t_max_exp_F": 30,    # For tmax-lim the figure of the ISF with the exponential fit
                "y_min_F": 0.765,
                "output": "/home/elena/fit/H-Pt/ajustes/42-fsi-T220-fr280-N4096-x4p2-xa4-g005-dt50-w50_N_800000.pdf"
            },
...
def procesar_multiples_datasets():
    ...
    output_pdf = 'b_R2_vs_tmin_plots-time.pdf'  # Set output file for the plots
    graficar_b_R2_vs_tmin(tiempos_minimos_all, b_values_all, R2_values_all, datasets, 'r^2-fr140-time.pdf')

    graficar_ajustes_exponenciales(datasets, 'I-vs-b-fr140-time.pdf')

    graficar_ajustes_b(datasets, 'b-vs-t-fr140-time.pdf', data_info['tmin_int'], data_info['tmax_int'], data_info['tm_ajuste'], data_info['t_max_exp'], data_info['tc_p0'], data_info['t_min_exp_F'], data_info['t_max_exp_F'], data_info['y_min_F'])

    graficar_ajustes_fit(datasets, 'I-vs-t-fr140-time.pdf', data_info['tmin_int'], data_info['tmax_int'], data_info['tm_ajuste'], data_info['tc_p0'], data_info['t_max_exp'])

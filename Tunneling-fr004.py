...
decay_data = np.loadtxt('decay-H-Elena-fr008.dat')
...
plt.savefig("Tunneling-H-fr004.pdf", dpi=300, bbox_inches='tight')
...
decay_data = np.loadtxt("/home/elena/fit/H-Pt/decay-H-Elena-fr008.dat")
...
# --------- Extraer puntos de decay-H-Elena.dat ----------
for ax, T in zip([ax1, ax2, ax3], [90, 140, 220]):
    ...
    if selected_point.size > 0 and selected_point.shape[1] >= 2:
        ...
        print(f"⚠️ Warning: No se encontró un punto válido para T={T}K en decay-H-Elena-fr008.dat")
...
plt.savefig("/home/elena/fit/H-Pt/aplha-vs-dk-fr004.pdf", format="pdf", dpi=300, bbox_inches='tight')
